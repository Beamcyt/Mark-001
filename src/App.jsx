...
<div class="row">
<div class="label">ข้าพเจ้า</div><div class="line" style="flex:2"></div>
...
<div class="sig">
  ...
  <div>ผู้ขอลา</div>
  <div style="margin-top:6px;font-size:12px;color:#555">วันที่ &nbsp;___/___/______</div>
</div>
<div class="sig">
  <div class="sig-line"></div>
  <div>พนักงานที่ควบคุม</div>
  <div style="margin-top:6px;font-size:12px;color:#555">วันที่ &nbsp;___/___/______</div>
  <div style="margin-top:10px;border-bottom:1px solid #000;margin-left:16px;margin-right:16px;padding-bottom:4px;min-height:22px"></div>
